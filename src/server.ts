...
app.get('/sitemap.xml', async (req, res) => {
  try {
    const backendUrl = process.env['API_URL'] || 'https://yalinnews.onrender.com';
    const frontendUrl = 'https://yalinnews.vercel.app';
    ...
    for (const news of newsList) {
      ...
      const date = news.publishDate || news.lastModified || new Date().toISOString();
      xml += `  <url>\n`;
